...
<body>
    <div class="container">
        ...
        <h3>Users Data</h3>
        <br />
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add Users</button>
...
function ajax_velocidad() {
	...
	$.ajax({
		...
		success: function(data){
			...
			var detalle = eval(data);
			
            for (var i = 0; i < detalle.length; i++)
			{
				col_services+=`<p>hello</p>`;
			}
			$("#list_img").html(col_services);
		},
		error: function()
		{
